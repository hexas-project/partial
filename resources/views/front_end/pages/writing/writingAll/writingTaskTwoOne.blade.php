...
<body>
    ...
    <div id="main-content">
        <form action="{{ route('writing.submit') }}" method="POST" id="taskoneClassFour" spellcheck="false" autocomplete="off">
            ...
            <input type="hidden" name="test_name" value="class12_writing">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 scroll-box">
                                ...
                                <p><strong>The graph below shows usual water usage (in millions of cubic meters) by industries in some countries in a year.</strong></p>
                                ...
                                <img src="{{ asset('images/writing/1.jpg') }}" class="img-fluid" alt=""><br>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 scroll-box">
                                ...
                                <p><strong>Some people believe that success in sports depends on physical strength, while others believe that mental strength is more important.</strong></p>
