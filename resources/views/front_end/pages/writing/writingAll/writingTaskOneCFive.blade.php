...
<body>
    ...
    <div id="main-content">
        <form action="{{ route('writing.submit') }}" method="POST" id="taskoneClassFive" spellcheck="false" autocomplete="off">
            @csrf
            <input type="hidden" name="student_id" value="{{ auth()->id() ?? session('student_batch_id') }}">
            <input type="hidden" name="test_name" value="class5_writing">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 scroll-box">
                                <p><strong>You are travelling next month to stay with a host family you do not know as part of a student exchange program. Write a letter to the family to introduce yourself. In your letter:</strong></p>
                                <ul>
                                    <li>say when and how you will be arriving</li>
                                    <li>tell the family a little about yourself</li>
                                    <li>ask about the weather to pack suitable clothes</li>
                                </ul>
                    ...
                    <div class="mt-4">
                        <div class="row">
                            ...
                            <div class="col-md-6 scroll-box">
                                ...
                                <p><strong>Some people believe that restoration of old buildings costs too much; we should demolish them and build new ones instead.</strong></p>
                ...
                <div class="tab-content " id="part3" style="margin-bottom: 30px;">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="row">
                            <!-- Column 1 -->
                            <div class="col-md-6 scroll-box">
                                <p class="mt-2"><strong>3.The chart below shows the number of complaints made about noise to Environmental Health authorities in the city of Newtown between 1980 and 1996.</strong></p>
                                <img src="{{ asset('images/taskOne11.png') }}" class="img-fluid" alt=""><br>
                                <br>
                            </div>
                            <!-- Column 2 -->
                            <div class="col-md-6 question_site">
                ...
                <div class="tab-content " id="part4" style="margin-bottom: 30px;">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="row">
                            <!-- Column 1 -->
                            <div class="col-md-6 scroll-box">
                                <p class="mt-2"><strong>4.the chart below shows the number of people expected to consume fast food in bangladesh from 2025 to 2050</strong></p>
                                <img src="{{ asset('images/taskOne12.png') }}" class="img-fluid" alt=""><br>
                                <br>
                            </div>
                            <!-- Column 2 -->
                            <div class="col-md-6 question_site">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            continueButton.addEventListener('click', () => {
                ...
                document.getElementById('taskoneClassFive').submit();
            });
