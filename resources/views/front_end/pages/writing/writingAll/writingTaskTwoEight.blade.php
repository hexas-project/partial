...
<body>
    ...
    <div id="main-content">
        <form action="{{ route('writing.submit') }}" method="POST" id="taskoneClassFour" spellcheck="false" autocomplete="off">
            ...
            <input type="hidden" name="test_name" value="class33_writing">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="scroll-box">
                                <p><strong>         The bar charts below show the Marriage and Divorce Statistics for eight countries in 1981 and 1994.<br><br>

        Write a short report for a university lecturer describing the information shown below.</strong></p>
                                <p>You should write at least 150 words.</p>
                                <div class="my-3 text-center">
                                    <img src="{{ asset('images/writing/writing8.png') }}" alt="Task Image" class="img-fluid w-100 task-image" style="max-width: 1000px; height: auto; margin: 0 auto;">
                                </div>
                            </div>
                        </div>
                ...
                <div class="tab-content" id="part2" style="margin-bottom: 80px;">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="scroll-box">
                                <p><strong>In many countries, people throw away a lot of food from restaurants and shops.</strong></p>
                                <p><strong>Why do you think people waste food in this way?</strong></p>
                                <p><strong>What can be done to reduce the amount of food thrown away?</strong></p>
