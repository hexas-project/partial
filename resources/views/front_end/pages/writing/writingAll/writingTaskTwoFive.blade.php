...
<body>
    ...
    <div id="main-content">
        <form action="{{ route('writing.submit') }}" method="POST" id="taskoneClassFour" spellcheck="false" autocomplete="off">
            ...
            <input type="hidden" name="test_name" value="class30_writing">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 scroll-box">
                                ...
                                <p><strong>The chart below shows estimated world illiteracy rates by region and by gender in 2000.</strong></p>
                                ...
                                <img src="{{ asset('images/writing/5.jpg') }}" class="img-fluid" alt=""><br>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 scroll-box">
                                ...
                                <p><strong>Some people think that famous people can help international aid organizations to draw attention to important problems. Others believe that the celebrities can make the problems seem less important.</strong></p>
...
<!-- highlight and note script from readingUnified -->
<script>
