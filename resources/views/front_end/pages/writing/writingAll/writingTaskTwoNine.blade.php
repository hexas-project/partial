...
<body>
    ...
    <div id="main-content">
        <form action="{{ route('writing.submit') }}" method="POST" id="taskoneClassFour" spellcheck="false" autocomplete="off">
            ...
            <input type="hidden" name="test_name" value="class34_writing">
            ...
            <div class="container-fluid px-5">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="scroll-box">
                                <p><strong>The table below gives information about UK independent films.<br><br>Summarize the information by selecting and reporting the main features, and make comparisons where relevant.</strong></p>
                                <p>You should write at least 150 words.</p>
                                <div class="my-3 text-center">
                                    <img src="{{ asset('images/writing/writing9.png') }}" alt="Task One" class="img-fluid w-100 task-image" style="max-width: 1000px; height: 500px; margin: 0 auto;">
                                </div>
                            </div>
                        </div>
                ...
                <div class="tab-content" id="part2" style="margin-bottom: 80px;">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="scroll-box">
                                <p><strong>The noise level around us is constantly increasing and affecting the quality of our lives.</strong></p>
                                
                                <p><strong>What are the causes of this problem?<br>What should be done to solve it?</strong></p>
