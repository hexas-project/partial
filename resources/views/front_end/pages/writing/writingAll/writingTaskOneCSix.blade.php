...
<body>
    ...
    <div id="main-content">
        <form action="{{ route('writing.submit') }}" method="POST" id="taskoneClassSix" spellcheck="false" autocomplete="off">
            @csrf
            <input type="hidden" name="student_id" value="{{ auth()->id() ?? session('student_batch_id') }}">
            <input type="hidden" name="test_name" value="class6_writing">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 scroll-box">
                                <p><strong>You recently received an invitation to a three-day training program which should benefit you and the company. Write a letter to your manager and say:</strong></p>
                                <ul>
                                    <li>Ask to attend the program.</li>
                                    <li>Describe the program.</li>
                                    <li>Explain how the program will benefit the company.</li>
                                </ul>
                    ...
                    <div class="mt-4">
                        <div class="row">
                            ...
                            <div class="col-md-6 scroll-box">
                                ...
                                <p><strong>It is expected in the near future that there will be a higher proportion of old people compared to younger population in some countries.</strong></p>
                                <p><strong>Is it a positive or negative development? Give your opinion and examples.</strong></p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            continueButton.addEventListener('click', () => {
                ...
                document.getElementById('taskoneClassSix').submit();
            });
