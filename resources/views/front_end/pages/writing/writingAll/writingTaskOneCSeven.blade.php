...
<body>
    ...
    <div id="main-content">
        <form action="{{ route('writing.submit') }}" method="POST" id="taskoneClassSeven" spellcheck="false" autocomplete="off">
            @csrf
            <input type="hidden" name="student_id" value="{{ auth()->id() ?? session('student_batch_id') }}">
            <input type="hidden" name="test_name" value="class7_writing">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 scroll-box">
                                <p><strong>Write a letter to your English speaking friend to invite him/her to see a movie about your country. In your letter say:</strong></p>
                                <ul>
                                    <li>Describe the movie.</li>
                                    <li>Why would he/she find it interesting?</li>
                                    <li>Suggest an arrangement to watch the movie together.</li>
                                </ul>
                    ...
                    <div class="mt-4">
                        <div class="row">
                            ...
                            <div class="col-md-6 scroll-box">
                                ...
                                <p><strong>These days it is very common to have people from two different generations mix in the same workplace.</strong></p>
                                <p><strong>Are there more advantages or disadvantages to this situation? Give your own opinion and include relevant examples.</strong></p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            continueButton.addEventListener('click', () => {
                ...
                document.getElementById('taskoneClassSeven').submit();
            });
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // Initial setup - default to 0 if exists
            if (allLinks.length > 0) setActiveQuestion(0);
        });
    </script>
