...
<body>
    ...
    <div id="main-content">
        <form action="{{ route('writing.submit') }}" method="POST" id="taskoneClassFour" spellcheck="false" autocomplete="off">
            ...
            <input type="hidden" name="test_name" value="class35_writing">
            ...
            <div class="container-fluid px-5">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="scroll-box">
                                <p><strong>The line graph below shows the number of annual visits to Australia by overseas residents. The table below gives information on the country of origin where the visitors came from.<br><br>Write a report for a university lecturer describing the information given.</strong></p>
                                <p>You should write at least 150 words.</p>
                                <div class="my-3 text-center">
                                   <img src="{{ asset('images/writing/writing10.png') }}" alt="Task One" class="img-fluid task-image">
                                </div>
                            </div>
                        </div>
                ...
                <div class="tab-content" id="part2" style="margin-bottom: 80px;">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="scroll-box">
                                <p><strong>The best way to solve the world’s environmental problems is to increase the cost of fuel for cars and other vehicles.<br><br>To what extent do you agree or disagree?</strong></p>
