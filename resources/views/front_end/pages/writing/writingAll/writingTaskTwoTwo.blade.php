...
<body>
    ...
    <div id="main-content">
        <form action="{{ route('writing.submit') }}" method="POST" id="taskoneClassFour" spellcheck="false" autocomplete="off">
            ...
            <input type="hidden" name="test_name" value="class27_writing">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 scroll-box">
                                ...
                                <p><strong>The pie charts show the average consumption of food in the world in 2008 compared to two countries; China and India.</strong></p>
                                ...
                                <img src="{{ asset('images/writing/2.jpg') }}" class="img-fluid" alt=""><br>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 scroll-box">
                                ...
                                <p><strong>Many people use written language in a less formal way and in a relaxed way than in the past.</strong></p>
