...
<body>
    ...
    <div id="main-content">
        <form action="{{ route('writing.submit') }}" method="POST" id="taskoneClassFour" spellcheck="false" autocomplete="off">
            ...
            <input type="hidden" name="test_name" value="class29_writing">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 scroll-box">
                                ...
                                <p><strong>The first chart below shows the results of a survey which sampled a cross-section of 100,000 people asking if they traveled abroad and why they traveled for the period 1994-98. The second chart shows their destinations over the same period.</strong></p>
                                ...
                                <table class="table table-bordered mt-3">
                                    <thead style="background-color: #f0e68c;">
                                        <tr>
                                            <th colspan="6" style="text-align: center;"><em>VISITS ABROAD BY UK RESIDENTS BY PURPOSE OF VISIT (1994-98)</em></th>
                                        </tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><em>Visits to friends & relatives</em></td>
                                            <td>2,689</td>
                                            <td>2,628</td>
                                            <td>2,774</td>
                                            <td>3,051</td>
                                        ...
                                        <tr style="background-color: #add8e6;">
                                            ...
                                            <td><strong>21,610</strong></td>
                                            <td><strong>24,949</strong></td>
                                            <td><strong>27,447</strong></td>
                                            <td><strong>28,828</strong></td>
                                        </tr>
                                    </tbody>
                                </table>
                                
                                <img src="{{ asset('images/writing/4.jpg') }}" class="img-fluid" alt=""><br>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 scroll-box">
                                ...
                                <p><strong>Some people believe that only the government can bring about significant changes in society, while others think that even an individual can have a lot of influence on society.</strong></p>
    ...
    <div class="tabs fixed-bottom " style="background-color: white; margin:0px; margin-top: 100px;">
        ...
        <div class="tab" data-tab="part2">
            ...
            <span class="question-placeholder">2 of 1</span>
        </div>
