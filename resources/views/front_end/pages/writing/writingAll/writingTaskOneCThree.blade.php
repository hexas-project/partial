...
<body>
    ...
    <div id="main-content">
        <form action="{{ route('writing.submit') }}" method="POST" id="taskoneClassThree" spellcheck="false" autocomplete="off">
            ...
            <input type="hidden" name="test_name" value="class3_writing">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 scroll-box">
                                 <p><strong>You recently saw an advertisement in a newspaper seeking volunteers to do unpaid work with local children. You are interested in this work. Write a letter to the head of the organization. In your letter:</strong></p>
                                 <ul>
                                     <li>Express your interest</li>
                                     <li>Ask for details of the work that needs to be done</li>
                                     <li>Let them know when you are available.</li>
                                 </ul>
                    ...
                    <div class="mt-4">
                        <div class="row">
                            ...
                            <div class="col-md-6 scroll-box">
                                ...
                                <p><strong>Some people think that air travel should be reduced to protect the environment.</strong></p>
