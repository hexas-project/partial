...
<body>
    ...
    <div id="main-content">
        <form action="{{ route('writing.submit') }}" method="POST" id="taskoneClassFour" spellcheck="false" autocomplete="off">
            ...
            <input type="hidden" name="test_name" value="class4_writing">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 scroll-box">
                                <p><strong>You came to know about a piece of equipment that would help you at your workplace. Write a letter to your manager. In your letter:</strong></p>
                                <ul>
                                    <li>Describe the equipment</li>
                                    <li>Explain how it might be useful at your workplace</li>
                                    <li>Offer help in purchasing it</li>
                                </ul>
                    ...
                    <div class="mt-4">
                        <div class="row">
                            ...
                            <div class="col-md-6 scroll-box">
                                ...
                                <p><strong>In many schools, sports lessons are part of the timetable, because it is important for both boys and girls to participate in sports.</strong></p>
                                <p><strong>Do you agree or disagree with this statement?</strong></p>
                                <p><strong>Give reasons for your answer and include relevant examples from your knowledge or experience.</strong></p>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 scroll-box">
                                ...
                                <p class="mt-2"><strong>4.The bar chart below shows shares of expenditures for five major categories in the United States, Canada,<br> the United Kingdom, and Japan in the year 2009.</strong></p>
