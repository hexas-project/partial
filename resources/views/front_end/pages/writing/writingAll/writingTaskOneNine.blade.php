...
<body>
    ...
    <div id="main-content">
        <form action="{{ route('writing.submit') }}" method="POST" id="taskoneClassNine" spellcheck="false" autocomplete="off">
            @csrf
            <input type="hidden" name="student_id" value="{{ auth()->id() }}">
            <input type="hidden" name="test_name" value="class17_writing">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 scroll-box">
                                ...
                                <p class="mt-2"><strong>1.The maps show changes in the local industrial village in England called Stamdorf between 1985 and 2015.</strong></p>
                                <img src="{{ asset('images/taskone21.png') }}" class="img-fluid" alt=""><br>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 scroll-box">
                                ...
                                <p class="mt-2"><strong>2. The two maps below show an island, before and after the construction of some tourist facilities</strong></p>
                                <img src="{{ asset('images/taskOne22.png') }}" class="img-fluid" alt=""><br>
