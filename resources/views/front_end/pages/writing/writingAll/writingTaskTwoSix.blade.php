...
<body>
    ...
    <div id="main-content">
        <form action="{{ route('writing.submit') }}" method="POST" id="taskoneClassFour" spellcheck="false" autocomplete="off">
            ...
            <input type="hidden" name="test_name" value="class31_writing">
            ...
            <div class="container-fluid px-5">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="scroll-box">
                                <p><strong>The graph below gives information about consumption of energy in the USA since 1980 with projections until 2030.<br><br>Summarize the information by selecting and reporting the main features, and making comparisons where relevant.</strong></p>
                                <p>You should write at least 150 words.</p>
                                <div class="my-3 text-center">
                                    <img src="{{ asset('images/writing/writing6.png') }}" alt="Task Image" class="img-fluid w-100 task-image" style="max-width: 1000px; height: auto; margin: 0 auto;">  
                                </div>
                            </div>
                        </div>
                ...
                <div class="tab-content" id="part2" style="margin-bottom: 80px;">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="scroll-box">
                                <p><strong>Computers today can quickly and accurately translate languages; therefore, it is a waste of time to learn a foreign language.</strong></p>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content" style="border-radius: 12px; overflow: hidden; border: none; box-shadow: 0 15px 35px rgba(0,0,0,0.2);">
                    ...
                    <div class="modal-body" style="padding: 30px 25px 20px; background-color: #fff; text-align: center;">
                        <p style="color: #777; margin-bottom: 25px; font-size: 14px; line-height: 1.4; padding: 0 10px;">Please enter your Student ID and click START TEST to begin the writting test.</p>
        ...
        window.addEventListener('DOMContentLoaded', () => {
            tabs.forEach(tab => {
                ...
                if (tab.getAttribute('data-tab') === 'part1') {
                    ...
                    qLinks.style.removeProperty('display');
                    qPlaceholder.style.removeProperty('display');
                }
            });
        });
    </script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            startTestButton.addEventListener('click', () => {
                ...
                if (!isValidStudentId) {
                    ...
                    errorMsg.style.display = 'flex'; // Changed to flex for alignment
                    errorMsg.textContent = "⚠️ Student ID must be at least 8 characters";
                    return;
                }
                ...
                if (!autoSaveIntervalId) {
                    console.log('Starting auto save interval - will run every 20 seconds');
                    autoSaveIntervalId = setInterval(autoSaveWriting, 20000);
                    console.log('Auto save interval ID:', autoSaveIntervalId);
                }
            });
...
<script>
function autoSaveWriting() {
  console.log('Auto save function called at:', new Date().toLocaleTimeString());
  ...
  fetch('{{ route('writing.autosave') }}', { method: 'POST', body: fd })
    .then(r => r.json())
    .then(d => {
      console.log('Auto save response:', d);
      console.log('Auto save status:', d.status);
    })
    .catch(err => {
