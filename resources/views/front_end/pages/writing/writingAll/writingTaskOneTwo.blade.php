...
<body>
    ...
    <div id="main-content">
        <form action="{{ route('writing.submit') }}" method="POST" id="taskoneClassFour" spellcheck="false" autocomplete="off">
            ...
            <input type="hidden" name="test_name" value="class2_writing">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 scroll-box">
                                 <p><strong>You have seen an advertisement looking for volunteers to teach English overseas. Write to the recruitment office. In your letter:</strong></p>
                                 <ul>
                                     <li>Tell them where you saw the advertisement</li>
                                     <li>Explain why you would like to go</li>
                                     <li>Describe the skills that you have that you think would help</li>
                                 </ul>
                    ...
                    <div class="mt-4">
                        <div class="row">
                            ...
                            <div class="col-md-6 scroll-box">
                                ...
                                <p><strong>Teenagers are spending an increasing amount of time on the Internet, and this is having a negative effect on their social skills.</strong></p>
                ...
                <div class="tab-content " id="part3" style="margin-bottom: 30px;">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="row">
                            <!-- Column 1 -->
                            <div class="col-md-6 scroll-box">
                                <h3 class="mt-2">Overall</h3>
                                <img src="{{ asset('images/Overall3.png') }}" class="img-fluid" alt=""><br>
                                <br>
                            </div>
                            <!-- Column 2 -->
                            <div class="col-md-6 question_site">
                ...
                <div class="tab-content " id="part4" style="margin-bottom: 30px;">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="row">
                            <!-- Column 1 -->
                            <div class="col-md-6 scroll-box">
                                <h3 class="mt-2"><strong>Overall</strong></h3>
                                <img src="{{ asset('images/Overall4.png') }}" class="img-fluid" alt=""><br>
                                <br>
                            </div>
                            <!-- Column 2 -->
                            <div class="col-md-6 question_site">
