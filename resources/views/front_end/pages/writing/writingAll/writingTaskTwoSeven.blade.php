...
<body>
    ...
    <div id="main-content">
        <form action="{{ route('writing.submit') }}" method="POST" id="taskoneClassFour" spellcheck="false" autocomplete="off">
            ...
            <input type="hidden" name="test_name" value="class32_writing">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="scroll-box">
                                <p><strong>         The plans below show a public park when it first opened in 1920 and the same park today.<br><br>

         Summarise the information by selecting and reporting the main features, and make comparisons where relevant.</strong></p>
                                <p>You should write at least 150 words.</p>
                                <div class="my-3 text-center">
                                    <img src="{{ asset('images/writing/writing7.png') }}" alt="Task Image" class="img-fluid w-100 task-image" style="max-width: 1000px; height: auto; margin: 0 auto;">  
                                </div>
                            </div>
                        </div>
                ...
                <div class="tab-content" id="part2" style="margin-bottom: 80px;">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="scroll-box">
                                <p><strong>Some people think watching television is bad for children in every way. Others believe it is good for developing children as they grow up.</strong></p>
