...
<head>
    ...
    <style>
        ...
        #startModal #modal_student_id:focus {
            border-color: #667eea;
            box-shadow: 0 0 0 3px rgba(102, 126, 234, 0.1);
            outline: none;
        }
        
        #startModal #modal_student_id::placeholder {
            color: #aaa;
        }
...
<body>
    ...
    <div id="main-content">
        <form action="{{ route('writing.submit') }}" method="POST" id="taskoneClassFour" spellcheck="false" autocomplete="off">
            ...
            <input type="hidden" name="test_name" value="class37_writing">
            ...
            <div class="container-fluid px-5">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="scroll-box">
                                <p><strong>The chart shows British Emigration to selected destinations between 2004 and 2007.<br><br>Summarize the information by selecting and reporting the main features and make comparisons where relevant.</strong></p>
                                <p>You should write at least 150 words.</p>
                                <div class="my-3 text-center">
                                   <img src="{{ asset('images/writing/writing12.png') }}" alt="Task 1" class="img-fluid w-100 task-image" style="max-width: 1000px; height: auto; margin: 0 auto; color: white">
                                </div>
                            </div>
                        </div>
                ...
                <div class="tab-content" id="part2" style="margin-bottom: 80px;">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="scroll-box">
                                <p><strong>Some people believe that children that commit crimes should be punished. Others think   parents should be punished instead.<br><br> Discuss both views and give your own opinion.</strong></p>
