...
<body>
    ...
    <script>
        ...
        // Auto-load Question 1 when page loads
        document.addEventListener('DOMContentLoaded', function() {
            // Check if we're on question-wise tab, if so show question 1
        ...
        function switchTab(tabName) {
            ...
            // If switching to question tab, show Question 1 by default
            if (tabName === 'question') {
                showQuestionDetail(1);
            }
        }
        ...
        function showQuestionDetail(questionNumber) {
            ...
            // Hide correct answer if student didn't attempt the question
        ...
        // Auto-redirect to student dashboard after 2 minutes
        setTimeout(function() {
