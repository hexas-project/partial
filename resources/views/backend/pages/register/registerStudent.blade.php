...
@section('content')
    <div class="container mt-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <button type="button" class="btn btn-success ms-auto px-6 py-2" data-bs-toggle="modal"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form method="POST" action="{{ route('users.update', $user->id) }}">
                                        ...
                                        <div class="mb-4">
                                            <label for="name"
                                                class="block text-sm font-semibold text-gray-700">Batch</label>
                                            <input id="name"
                                                class="mt-1 block w-full p-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500"
                                                type="text" name="batch" value="{{ old('batch', $user->batch) }}"
                                                >
                                            @error('batch')
                                                <p class="text-red-500 text-xs mt-2">{{ $message }}</p>
                                            @enderror
                    ...
                    <div class="bg-white p-6 rounded-lg  w-96">
                        ...
                        <form method="POST" action="{{ route('register.user.create') }}" style="margin-top:20px;">
                            ...
                            <div class="mb-4">
                             ...
                             <!-- Batch Name -->
                            <div class="mb-4">
                                <label for="name" class="block text-sm font-semibold text-gray-700">Batch</label>
                                <input id="name"
                                    class="mt-1 block w-full p-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500"
                                    type="text" name="batch" value="{{ old('batch') }}"  autofocus
                                    autocomplete="batch">
                                @error('name')
                                    <p class="text-red-500 text-xs mt-2">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <button type="submit"
                                    class="px-6 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500">Register</button>
                            </div>
                        </form>
                    </div>
                </div>
