          <nav class="layout-navbar container-xxl navbar-detached navbar navbar-expand-xl align-items-center bg-navbar-theme"
              ...
              <div class="navbar-nav-right d-flex align-items-center justify-content-between w-100" id="navbar-collapse">
                  ...
                  <div class="navbar-brand-text">
                      <h4 class="mb-0" style="font-size: 20px; font-weight: 800; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; letter-spacing: 2px; text-shadow: 0 2px 10px rgba(102, 126, 234, 0.3);">
                          HEXA'S ZINDABAZAR
                      </h4>
                  </div>
                  <!-- /Brand Name -->
                                      ...
                                      <div class="d-flex align-items-center">
                                          ...
                                          <div class="flex-grow-1">
                                              ...
                                              <small class="text-body-secondary">
                                                  {{ Auth::check() && Auth::user()->role == 1 ? 'Admin' : 'Student' }}
                                              </small>
                                          </div>
                                      </div>
                                  </a>
